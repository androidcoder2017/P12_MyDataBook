...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alDatabook = new ArrayList<DataBook>();
        alDatabook.add(new DataBook("Bio", 0));
        alDatabook.add(new DataBook("Vaccination", 1));
        alDatabook.add(new DataBook("Anniversary", 2));
        alDatabook.add(new DataBook("About Us", 3));

        aa = new DataBookAdapter(this, R.layout.row, alDatabook);
