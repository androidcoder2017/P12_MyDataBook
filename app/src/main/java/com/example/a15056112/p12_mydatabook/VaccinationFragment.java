    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                etPassphrase = (EditText) passPhrase.findViewById(R.id.editTextPassPhrase);
                ...
                builder.setTitle("Edit Bio")
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                               vaccination = etPassphrase.getText().toString();
                                DatabaseReference dbr = editLists;
                                dbr.child("Vaccination").setValue(vaccination);
                            }
                        });
    ...
    private void firebase() {
        editLists.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                String lists = dataSnapshot.child("Vaccination").getValue(String.class);
                tv.setText(lists);
            }
